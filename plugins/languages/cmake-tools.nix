...
helpers.neovim-plugin.mkNeovimPlugin config {
  ...
  maintainers = with helpers.maintainers; [
    MattSturgeon
    NathanFelber
  ];
  ...
  settingsOptions = {
    ...
    cmake_notifications =
      helpers.mkCompositeOption
        ...
        ''
        {
          runner = helpers.mkCompositeOption "" { enabled = helpers.defaultNullOpts.mkBool true ""; };

          executor = helpers.mkCompositeOption "" { enabled = helpers.defaultNullOpts.mkBool true ""; };
